                ...
                <div className="py-3">
                  ...
                  <div className="d-flex gap-10 flex-column my-3">
                    ...
                    <p className="product-data">
                      ...
                      <br /> Nous livrons toutes nos commandes dans un délai de{' '}
                      <b>5-10 jours ouvrés.</b>
                    </p>
                  </div>
            ...
            <div className="col-12">
              ...
              <div className="bg-white p-3">
                <p>
                  ...
                  condimentum fermentum commodo. Donec pulvinar feugiat massa eu
                  sagittis. Etiam a nisl sit.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-12">
              ...
              <div className="review-inner-wrapper">
                <div className="review-head d-flex justify-content-between align-items-end">
                  <div>
                    <h4 className="mb-2">Retours Clientèle</h4>
                    <div className="d-flex align-items-center gap-10">
                      <ReactStars
                        count={5}
                        value={3}
                        ...
                        activeColor="#ffd700"
                      />
                      <p className="mb-0">Basé sur 2 Retours</p>
                    </div>
                  </div>
                  {orderedProduct && (
                    <div>
                ...
                <div className="reviews mt-4">
                  <div className="review">
                    ...
                    <p className="mt-3">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Vivamus placerat accumsan mi, sit amet posuere ante.
                      Vivamus condimentum fermentum commodo. Donec pulvinar
                      feugiat massa eu sagittis. Etiam a nisl sit.
                    </p>
                  </div>
                </div>
              </div>
